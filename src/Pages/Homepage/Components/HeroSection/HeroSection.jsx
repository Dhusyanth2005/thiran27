...
export default function HeroSection() {
  return (
    <section className="hero" aria-label="Thiran 2026 event poster">
      <img
        src={heroBanner}
        alt="Sri Eshwar Thiran 2026 — Confluence of Talents. A national level inter-college techno cultural sports fest, Feb 4, 5 & 6, 2026. ₹15 Lakh worth of prizes."
